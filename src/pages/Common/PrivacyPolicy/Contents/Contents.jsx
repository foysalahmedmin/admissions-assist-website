  ...
  return (
    <section>
      <div className="container mx-auto">
        <div className="mb-7">
          <h3 className="title text-3xl mb-7">Privacy Policy</h3>
          <p>
        ...
        <div className="mb-7">
          <h3 className="title text-3xl mb-7">Links to other websites</h3>
          <p>
            ...
            Lemon Squeezy, are under the control of Lemon Squeezy. We encourage
            purchasers to read Lemon Squeezy's Privacy Policy.
          </p>
        </div>
        <div className="mb-7">
          ...
          <div>
            <div className="mb-7">
              <h3 className="title text-xl mb-7">Business Transactions</h3>
              <p>
            ...
            <div className="mb-7">
              <h3 className="title text-xl mb-7">Law enforcement</h3>
              <p>
            ...
            <div className="mb-7">
              <h3 className="title text-xl mb-7">Other legal requirements</h3>
              <p className="mb-4">
        ...
        <div className="mb-7">
          <h3 className="title text-3xl mb-7">Contact Us</h3>
          <p className="mb-4">
